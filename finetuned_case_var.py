...
their_model_str = "ufal/robeczech-base"
model_str = "./czech-finetune/checkpoint-3000"

from transformers import AutoTokenizer, AutoModelForMaskedLM, AutoConfig

tokenizer = AutoTokenizer.from_pretrained(their_model_str)
...
def run_random(case_name):
	...
	pickle.dump(aav, open("new-" + rel_str + ".pkl", "wb"))
...
def run_test(case_name, other_case):
	...
	if os.path.exists("new-" + c1_short + "-all.pkl"): return
	...
	pickle.dump(rav, open("new-" + c1_short + "-all.pkl", "wb"))

for case in case_to_num:
	run_random(case)
